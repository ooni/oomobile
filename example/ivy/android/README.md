...
Requirements
  ...
  - Android SDK
  - Android NDK
  - `github.com/ooni/oomobile/cmd/gomobile`
...
`robpike.io/ivy` and `github.com/ooni/oomobile` are required dependencies of this main module. In order to update them:

```
  go get -d github.com/ooni/oomobile@latest
