...
import (
	...
	"github.com/ooni/oomobile/internal/importers/java"
...
func TestClasses(t *testing.T) {
	...
	runTest(t, []string{
		"github.com/ooni/oomobile/bind/testdata/testpkg/javapkg",
	}, "", "ClassesTest")
}
...
func TestJavaSeqBench(t *testing.T) {
	...
	runTest(t, []string{"github.com/ooni/oomobile/bind/testdata/benchmark"}, "", "SeqBench")
}
