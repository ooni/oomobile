...
var tests = []struct {
...
}{
	{
		name: "ObjC-Testpkg",
		lang: "objc",
		pkg:  "github.com/ooni/oomobile/bind/testdata/testpkg",
	},
	{
		name: "Java-Testpkg",
		lang: "java",
	...
	},
	{
		name:    "Java-Javapkg",
		lang:    "java",
		pkg:     "github.com/ooni/oomobile/bind/testdata/testpkg/javapkg",
		goos:    "android",
		reverse: true,
	},
	{
	...
	},
	{
		name: "Go-Cgopkg",
		lang: "go,java,objc",
		pkg:  "github.com/ooni/oomobile/bind/testdata/cgopkg",
		goos: "android",
	},
}
...
type Struct struct{
	...
	exported := packagestest.Export(t, exporter, []packagestest.Module{
		...
		{
			// gobind requires github.com/ooni/oomobile to generate code for reverse bindings.
			Name:  "github.com/ooni/oomobile",
			Files: packagestest.MustCopyFileTree("../.."),
		},
	})
