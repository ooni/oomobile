...
func TestAndroidBuild(t *testing.T) {
	...
	cmdBuild.flag.Parse([]string{"github.com/ooni/oomobile/example/basic"})
	oldTags := buildTags
...
func TestRegexImportGolangXPackage(t *testing.T) {
	tests := []struct {
		...
		{"ffffffff t github.com/ooni/oomobile", "github.com/ooni/oomobile", 2},
		{"ffffffff t github.com/example/repo/vendor/github.com/ooni/oomobile", "github.com/ooni/oomobile", 2},
		{"ffffffff t github.com/example/github.com/ooni/oomobile", "", 0},
		{"ffffffff t github.com/example/repo", "", 0},
		{"ffffffff t github.com/example/repo/vendor", "", 0},
		{"ffffffff t _github.com/ooni/oomobile/app", "github.com/ooni/oomobile/app", 2},
	}
	...
	for _, target := range []string{"android", "ios"} {
		t.Run(target, func(t *testing.T) {
			...
			tests := []struct {
				...
				{
					Name: "Absolute Path",
					Path: "github.com/ooni/oomobile/example/basic",
				},
				{
					Name: "Relative Path",
					Path: "./example/basic",
